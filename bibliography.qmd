...
* [ADAS Utils](https://pbosetti.r-universe.dev/adas.utils){target="_blank"}---Design of Experiments
* [geotopbricks](https://ecor.r-universe.dev/geotopbricks){target="_blank"}---An R Plug-in for the Distributed Hydrological Model GEOtop
* [mdbplyr](https://pbosetti.r-universe.dev/mdbplyr)---A tidy interface to MongoDB, a popular NoSQL database.
* [noisyCE2](https://f-santi.r-universe.dev/noisyCE2){target="_blank"}---Cross-Entropy Optimisation of Noisy Functions
* [RGENERATE](https://ecor.r-universe.dev/RGENERATE){target="_blank"}---Tools to Generate Vector Time Series
* [RMAWGEN](https://ecor.r-universe.dev/RMAWGEN){target="_blank"}---Multi-Site Auto-Regressive Weather GENerator

```{r}
#| echo: false
pp <- cran_stats(c("adas.utils", "noisyCE2", "RMAWGEN", "RGENERATE", "geotopbricks", "mdbplyr")) %>% 
